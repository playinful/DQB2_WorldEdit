...
namespace EyeOfRubiss
{
    ...
    public class CommonData : SaveData
    {
        ...
        public const int HEADER_LENGTH = 0x2A444;
        ...
        public bool TimeIsPassing { get => GetBit(0x500, 1); set => SetBit(0x500, 1, value); }
        ...
        public static bool TryLoad(string path, out CommonData result)
        {
            result = null;
        ...
        public class Resident(CommonData saveData, int index)
        {
            ...
            public bool Dead { get { return SaveData.GetBit(GetAddress() + 0x134, 1); } set { SaveData.SetBit(GetAddress() + 0x134, 1, value); } }
            ...
            {
                Dead = false;
                if (SaveData.GetByte(GetAddress() + 0xE3) == 0x1C)
                    SaveData.SetByte(GetAddress() + 0xE3, 1);
            }
        }
