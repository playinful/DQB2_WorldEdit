...
{
    public class ParamDataPS3 : ParamData
    {
        ...
        public override uint WorldChecksum { get { return GetUInt32(0x8, littleEndian: false); } set { SetUInt32(0x8, value, littleEndian: false); } }
        ...
        public override float PlayerPositionX { get => GetSingle(0x1D360, littleEndian: false); set => SetSingle(0x1D360, value, littleEndian: false); }
        public override float PlayerPositionY { get => GetSingle(0x1D364, littleEndian: false); set => SetSingle(0x1D364, value, littleEndian: false); }
        public override float PlayerPositionZ { get => GetSingle(0x1D368, littleEndian: false); set => SetSingle(0x1D368, value, littleEndian: false); }

        public override float PlayerRotation { get => GetSingle(0x1D370, littleEndian: false); set => SetSingle(0x1D370, value, littleEndian: false); }
        ...
        public override float Time { get => GetSingle(0x1E528, littleEndian: false); set => SetSingle(0x1E528, value, littleEndian: false); }
        public override ushort Weather { get => GetUInt16(0x1E52C, littleEndian: false); set => SetUInt16(0x1E52C, value, littleEndian: false); }

        public override uint Score { get => GetUInt32(0x2604, littleEndian: false); set { SetUInt32(0x2604, value, littleEndian: false); SetUInt32(0x2608, value, littleEndian: false); } } // PS3: 0x2608 == 00000000?
        ...
        public static bool TryLoad(string path, out ParamDataPS3 result)
        {
            result = null;
            ParamDataPS3 paramData = new();
        ...
        public override InventoryItem GetHotbarItem(int index)
        {
            ...
            return new InventoryItem(this, HOTBAR_ADDRESS + index * InventoryItem.LENGTH, littleEndian: false);
        }
        public override InventoryItem GetBagItem(int index)
        {
            ...
            return new InventoryItem(this, BAG_ADDRESS + index * InventoryItem.LENGTH, littleEndian: false);
        }
        public override InventoryItem GetEquipment(int index)
        {
            ...
            return new InventoryItem(this, EQUIPMENT_ADDRESS + index * InventoryItem.LENGTH, littleEndian: false);
        }
        public override InventoryItem GetBagEquipment(int index)
        {
            ...
            return new InventoryItem(this, EQUIPMENT_BAG_ADDRESS + index * InventoryItem.LENGTH, littleEndian: false);
        }
        #endregion
        
        #region Residents
        new public class Resident(ParamDataPS3 saveData, int index) : ParamData.Resident(saveData, index)
        {
            public const int START_ADDRESS = 0x2620;

            public override int GetAddress() => START_ADDRESS + Index * LENGTH;

            public override float PositionX { get => SaveData.GetSingle(GetAddress(), littleEndian: false); set => SaveData.SetSingle(GetAddress(), value, littleEndian: false); }
            public override float PositionY { get => SaveData.GetSingle(GetAddress() + 4, littleEndian: false); set => SaveData.SetSingle(GetAddress() + 4, value, littleEndian: false); }
            public override float PositionZ { get => SaveData.GetSingle(GetAddress() + 8, littleEndian: false); set => SaveData.SetSingle(GetAddress() + 8, value, littleEndian: false); }

            public override float Rotation { get => SaveData.GetSingle(GetAddress() + 0x10, littleEndian: false); set => SaveData.SetSingle(GetAddress() + 0x10, value, littleEndian: false); }

            public override ushort ResidentID { get => SaveData.GetUInt16(GetAddress() + 0x14, littleEndian: false); set => SaveData.SetUInt16(GetAddress() + 0x14, value, littleEndian: false); }
            public override ushort Type { get => SaveData.GetUInt16(GetAddress() + 0x16, littleEndian: false); set => SaveData.SetUInt16(GetAddress() + 0x16, value, littleEndian: false); }

            public override ushort HP { get => SaveData.GetUInt16(GetAddress() + 0x18, littleEndian: false); set => SaveData.SetUInt16(GetAddress() + 0x18, value, littleEndian: false); }
        ...
        new public class ColossalCoffer(ParamDataPS3 saveData) : ParamData.ColossalCoffer(saveData)
        {
            public override ushort X { get { return SaveData.GetUInt16(ADDRESS, littleEndian: false); } set { SaveData.SetUInt16(ADDRESS, value, littleEndian: false); } }
            public override ushort Z { get { return SaveData.GetUInt16(ADDRESS + 2, littleEndian: false); } set { SaveData.SetUInt16(ADDRESS + 2, value, littleEndian: false); } }
        ...
        new public class Storage(ParamDataPS3 saveData, int metadataAddress, int contentsAddress) : ParamData.Storage(saveData, metadataAddress, contentsAddress)
        {
            public const int START_ADDRESS_CONTENTS = 0x4549C;

            public override ushort X { get { return SaveData.GetUInt16(MetadataAddress, littleEndian: false); } set { SaveData.SetUInt16(MetadataAddress, value, littleEndian: false); } }
            public override ushort Z { get { return SaveData.GetUInt16(MetadataAddress + 2, littleEndian: false); } set { SaveData.SetUInt16(MetadataAddress + 2, value, littleEndian: false); } }
            ...
            public override InventoryItem GetItem(int index)
            {
                ...
                return new(SaveData, ContentsAddress + index * InventoryItem.LENGTH, littleEndian: false);
            }
        }
        ...
        new public class ItemDisplay(ParamDataPS3 saveData, int metadataAddress, int contentsAddress) : ParamData.ItemDisplay(saveData, metadataAddress, contentsAddress)
        {
            ...
            public override InventoryItem Item => new(SaveData, ContentsAddress, littleEndian: false);
        }
        ...
        new public class Signpost(ParamDataPS3 saveData, int address) : ParamData.Signpost(saveData, address)
        {
            public override ushort X { get { return SaveData.GetUInt16(Address, littleEndian: false); } set { SaveData.SetUInt16(Address, value, littleEndian: false); } }
            public override ushort Z { get { return SaveData.GetUInt16(Address + 2, littleEndian: false); } set { SaveData.SetUInt16(Address + 2, value, littleEndian: false); } }
            public override byte Y { get { return SaveData.GetByte(Address + 4); } set { SaveData.SetByte(Address + 4, value); } }
        ...
        new public class Teleportal(ParamDataPS3 saveData, int address) : ParamData.Teleportal(saveData, address)
        {
            public override ushort X { get { return SaveData.GetUInt16(Address, littleEndian: false); } set { SaveData.SetUInt16(Address, value, littleEndian: false); } }
            public override ushort Z { get { return SaveData.GetUInt16(Address + 2, littleEndian: false); } set { SaveData.SetUInt16(Address + 2, value, littleEndian: false); } }
            public override byte Y { get { return SaveData.GetByte(Address + 4); } set { SaveData.SetByte(Address + 4, value); } }
        ...
        new public class Naviglobe(ParamDataPS3 saveData, int address) : ParamData.Naviglobe(saveData, address)
        {
            public override ushort X { get { return SaveData.GetUInt16(Address, littleEndian: false); } set { SaveData.SetUInt16(Address, value, littleEndian: false); } }
            public override ushort Z { get { return SaveData.GetUInt16(Address + 2, littleEndian: false); } set { SaveData.SetUInt16(Address + 2, value, littleEndian: false); } }
            public override byte Y { get { return SaveData.GetByte(Address + 4); } set { SaveData.SetByte(Address + 4, value); } }
        ...
        new public class SharingStone(ParamDataPS3 saveData) : ParamData.SharingStone(saveData)
        {
        ...
        new public class SummoningStone(ParamDataPS3 saveData, int address) : ParamData.SummoningStone(saveData, address)
        {
        ...
        // new public class AncientTeleportal(ParamDataPS3 saveData) : ParamData.AncientTeleportal(saveData)
        // {
        //    // TODO
        // }
