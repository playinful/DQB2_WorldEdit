...
{
    public class ParamDataVita : ParamData
    {
        public const int HOTBAR_ADDRESS = 0x43C20;
        public const int EQUIPMENT_ADDRESS = 0x43C5C;
        public const int BAG_ADDRESS = 0x43C9C;
        public const int EQUIPMENT_BAG_ADDRESS = 0x43F9C;
        ...
        public override float PlayerPositionX { get => GetSingle(0x1D350); set => SetSingle(0x1D350, value); }
        public override float PlayerPositionY { get => GetSingle(0x1D354); set => SetSingle(0x1D354, value); }
        public override float PlayerPositionZ { get => GetSingle(0x1D358); set => SetSingle(0x1D358, value); }

        public override float PlayerRotation { get => GetSingle(0x1D360); set => SetSingle(0x1D360, value); }
        ...
        public override float Time { get => GetSingle(0x1E518); set => SetSingle(0x1E518, value); }
        public override ushort Weather { get => GetUInt16(0x1E51C); set => SetUInt16(0x1E51C, value); }
        ...
        public static bool TryLoad(string path, out ParamDataVita result)
        {
            result = null;
            ParamDataVita paramData = new();
        ...
        #region Residents
        new public class Resident(ParamDataVita saveData, int index) : ParamData.Resident(saveData, index)
        {
            public const int START_ADDRESS = 0x2618;
        ...
        new public class ColossalCoffer(ParamDataVita saveData) : ParamData.ColossalCoffer(saveData)
        {
        ...
        new public class Storage(ParamDataVita saveData, int metadataAddress, int contentsAddress) : ParamData.Storage(saveData, metadataAddress, contentsAddress)
        {
            public const int START_ADDRESS_CONTENTS = 0x4409C;
        ...
        new public class ItemDisplay(ParamDataVita saveData, int metadataAddress, int contentsAddress) : ParamData.ItemDisplay(saveData, metadataAddress, contentsAddress)
        {
            public const int START_ADDRESS_ITEM_DISPLAY_CONTENTS = 0x4509C;
            public const int START_ADDRESS_EQUIPMENT_DISPLAY_CONTENTS = 0x4511C;
        ...
        new public class Signpost(ParamDataVita saveData, int address) : ParamData.Signpost(saveData, address)
        {
            public override ushort X { get { return SaveData.GetUInt16(Address); } set { SaveData.SetUInt16(Address, value); } }
            public override ushort Z { get { return SaveData.GetUInt16(Address + 2); } set { SaveData.SetUInt16(Address + 2, value); } }
            public override byte Y { get { return SaveData.GetByte(Address + 4); } set { SaveData.SetByte(Address + 4, value); } }
        ...
        new public class Teleportal(ParamDataVita saveData, int address) : ParamData.Teleportal(saveData, address)
        {
            public override ushort X { get { return SaveData.GetUInt16(Address); } set { SaveData.SetUInt16(Address, value); } }
            public override ushort Z { get { return SaveData.GetUInt16(Address + 2); } set { SaveData.SetUInt16(Address + 2, value); } }
            public override byte Y { get { return SaveData.GetByte(Address + 4); } set { SaveData.SetByte(Address + 4, value); } }
        ...
        new public class Naviglobe(ParamDataVita saveData, int address) : ParamData.Naviglobe(saveData, address)
        {
            public override ushort X { get { return SaveData.GetUInt16(Address); } set { SaveData.SetUInt16(Address, value); } }
            public override ushort Z { get { return SaveData.GetUInt16(Address + 2); } set { SaveData.SetUInt16(Address + 2, value); } }
            public override byte Y { get { return SaveData.GetByte(Address + 4); } set { SaveData.SetByte(Address + 4, value); } }
        ...
        new public class SharingStone(ParamDataVita saveData) : ParamData.SharingStone(saveData)
        {
            public const int ADDRESS = 0x12070;
        ...
        new public class SummoningStone(ParamDataVita saveData, int address) : ParamData.SummoningStone(saveData, address)
        {
            public const int START_ADDRESS = 0x12194;
        ...
        // new public class AncientTeleportal(ParamDataVita saveData) : ParamData.AncientTeleportal(saveData)
        // {
        //    // TODO
        // }
